...
// Delete event if 'delete' is clicked
    ...
    <div class="admin-container">
        ...
        <aside class="sidebar">
            ...
            <nav class="nav-links">
                ...
                <a href="edit_delete_events.php" style="background-color: #b0070d;">Edit/Delete Events</a>
                ...
                <?php while ($row = $result->fetch_assoc()): ?>
                    <div class="card">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="edit_delete_events.php?delete=<?php echo $row['event_id']; ?>" onclick="return confirm('Are you sure you want to delete this event?')">Delete</a>
                        </div>
                    </div>
                <?php endwhile; ?>
            <?php else: ?>
